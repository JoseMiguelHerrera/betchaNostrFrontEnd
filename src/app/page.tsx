  ...
  useEffect(() => {
    ...
    async function nostrTest() {
      ...
      try {
        ...
        console.log("created my nostr instance")
      } catch (e) {
      ...
      try {
        profile = await ndk.getUserProfile()
      } catch (e:any) {
        if (e.toString().includes("extension not available")) {
          toast.info("No NOSTR Extension - read only mode");
        }
      }
